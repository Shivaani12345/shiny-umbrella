...
def camera(get_blueprint_of_world):
    camera_sensor = get_blueprint_of_world
...
try:
    ...
    simulator_camera_location_rotation = carla.Transform(spawn_points.location, spawn_points.rotation)
    simulator_camera_location_rotation.location += spawn_points.get_forward_vector() * 30
